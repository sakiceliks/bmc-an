...
export function Navbar({ setIsMenuOpen }: { setIsMenuOpen: (open: boolean) => void }) {
  return (
    ...
    <div className="fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-sm">
      ...
      <nav className="flex items-center gap-2 sm:gap-4 md:gap-6 text-xs sm:text-sm flex-shrink-0">
